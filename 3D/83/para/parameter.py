...
class Parameter(object):
    ...
    def extract_args(self):
        ...
        self.parser.add_argument('--data_root', type=str, default='/home/ayt/TurbMAE/3D/data_224_new/train')
        self.parser.add_argument('--data_valid_root', type=str, default='/home/ayt/TurbMAE/3D/data_224_new/val')
        self.parser.add_argument('--data_test_root', type=str, default='/home/ayt/TurbMAE/3D/data_224_new/test')
        ...
        self.parser.add_argument('--resume_file', type=str,default='/home/ayt/TurbMAE/3D/83/experiment/2025_12_19_20_48_02_TEPN_MATID/model_best.pth.tar')
        ...
        self.parser.add_argument('--log_path', type=str, default='./experiment/83.txt')
