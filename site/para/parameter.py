...
class Parameter(object):
    ...
    def extract_args(self):
        ...
        self.parser.add_argument('--data_root', type=str, default='/home/ayt/TurbMAE/3D/data_nanji/train')
        self.parser.add_argument('--data_valid_root', type=str, default='/home/ayt/TurbMAE/3D/data_nanji/test')
        self.parser.add_argument('--data_test_root', type=str, default='/home/ayt/TurbMAE/3D/data_nanji/test')
        ...
        self.parser.add_argument('--log_path', type=str, default='./experiment/83_nanji.txt')
